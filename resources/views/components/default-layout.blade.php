...
<body class="bg-zinc-100">
    <main>
        <header x-data="{ open: false }"
            class="flex items-center justify-between sm:justify-start gap-8 bg-white border-b border-b-zinc-100 sticky top-0 px-3 sm:px-10 py-4">
            <h2 class="text-xl sm:text-xl font-bold">Student Management</h2>
            {{-- Desktop navigation --}}
            <nav>
